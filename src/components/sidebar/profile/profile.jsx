...
const ProfilePopup = ({ isOpen, onClose }) => {
  return (
    <>
      {isOpen && (
        <div className="fixed top-0 right-0 mt-16 mr-4 bg-opacity-50 flex justify-end items-start">
          <div
            className="bg-slate-300 rounded-lg p-8"
            style={{
              boxShadow:
...
const ProfileCard = () => {
  return (
    <div class=" dark:bg-gray-700 bg-gray-200 pt-12 rounded-2xl">
